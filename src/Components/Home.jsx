...
const Home = () => {
    ...
    return (
        <div className="relative w-full h-screen bg-[#010532] overflow-hidden shadow-[0px_24px_54.9px_rgba(0,0,0,0.75)] bg-cover bg-no-repeat bg-center justify-between" style={{ backgroundImage: "url(https://placehold.co/1440x862)" }}>
            ...
            {/* Flip Container */}
            <div className={`absolute top-[243px] left-[63px] w-[633px] h-[480px] perspective my-[-60px] mx-[80px] mt-[0px] z-20 transition-all duration-1000 ease-out ${animateEntry ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'
                }`}>
                <div className={`relative w-full h-full preserve-3d transition-transform-3d ${isFlipped ? 'rotate-y-180' : ''}`}>
